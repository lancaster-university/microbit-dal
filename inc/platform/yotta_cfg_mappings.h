...
#ifdef YOTTA_CFG_MICROBIT_DAL_BLUETOOTH_CLIENT_EVENT_WRITE_TYPES
#define MICROBIT_BLE_CLIENT_EVENT_WRITE_TYPES YOTTA_CFG_MICROBIT_DAL_BLUETOOTH_CLIENT_EVENT_WRITE_TYPES
#endif
