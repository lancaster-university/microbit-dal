...
// filesystem mappings
#ifdef YOTTA_CFG_MICROBIT_DAL_INTERFACE_FS
    #define MICROBIT_IF_CHIP_FS YOTTA_CFG_MICROBIT_DAL_INTERFACE_FS
#endif

#ifdef YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_ENABLE
    #define MICROBIT_IF_CHIP_PRESERVE YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_ENABLE
#elif defined(YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P1) || defined(YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P2)
    #define MICROBIT_IF_CHIP_PRESERVE               1
#endif

#ifdef YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P1
    #define MICROBIT_IF_PRES_1 YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P1
#endif

#ifdef YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P1
    #define MICROBIT_IF_PRES_2 YOTTA_CFG_MICROBIT_DAL_INTERFACE_PRESERVE_P2
#endif
